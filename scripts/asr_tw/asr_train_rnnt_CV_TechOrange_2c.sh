...
EXP_NAME=aishell1_fc_rnnt_bpe_${EXP}_7000_${EPOCH}_n${node}_bs${TRAIN_BATCH_SIZE}_lr${LR}_a100_600M_spec00
...
if [[ $DEBUG == true ]]
then
  PYTHON_SCRIPT="scripts/asr_tw/debug_wrapper_hybrid.py"
  ...
  PYTHON_SCRIPT="examples/asr/asr_hybrid_transducer_ctc/speech_to_text_hybrid_rnnt_ctc_bpe.py"
fi
