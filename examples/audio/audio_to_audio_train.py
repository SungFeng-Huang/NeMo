...
from nemo.collections.audio.models.codec_to_audio import CodecFlowMatchingAudioToAudioModel
...
class ModelType(str, Enum):
    ...
    CodecFlowMatching = 'codec_flow_matching'
...
def get_model_class(model_type: ModelType):
    ...
    elif model_type == ModelType.CodecFlowMatching:
        return CodecFlowMatchingAudioToAudioModel
    else:
