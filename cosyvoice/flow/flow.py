...
class MaskedDiffWithXvec(torch.nn.Module):
    ...
    Args:
        ...
        learnable_prompt: Whether to use learnable prompt tokens.
    """
    def __init__(self,
                 input_size: int = 512,
                 output_size: int = 80,
...
class CausalMaskedDiffWithXvec(torch.nn.Module):
    """
    Causal version of MaskedDiffWithXvec for streaming inference with causal masking.
    This model supports real-time text-to-speech synthesis with lookahead context.
    ...
    Args:
        ...
        input_frame_rate: Frame rate for input tokens.
        only_mask_loss: Whether to use only masked loss.
        token_mel_ratio: Ratio between token and mel frame lengths.
        pre_lookahead_len: Number of lookahead tokens for causal processing.
        encoder: Encoder module (e.g., Transformer/Conformer).
        decoder: Conditional flow-based decoder module.
        decoder_conf: Decoder configuration dictionary.
        mel_feat_conf: Mel-spectrogram feature configuration.
    ...
    def forward(
        ...
        """
        Training forward pass with streaming support.
        Args:
            batch: Dictionary containing input tokens, lengths, features, and speaker embedding.
            device: Target device.
        Returns:
    ...
    def inference(self,
                  ...
                  finalize):
        """
        Streaming inference pass with causal masking.
        Args:
            token: Target text tokens [B, T]
            token_len: Lengths of target tokens [B]
            prompt_token: Prompt tokens (for context) [B, T_p]
